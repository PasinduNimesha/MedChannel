...
class PhysicianRegisterationScreen extends StatefulWidget {
  final String id;
  const PhysicianRegisterationScreen({Key? key, required this.id}) : super(key: key);

  @override
  _PhysicianRegisterationScreenState createState() => _PhysicianRegisterationScreenState();
}

class _PhysicianRegisterationScreenState extends State<PhysicianRegisterationScreen> {
